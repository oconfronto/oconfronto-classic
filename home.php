...
if (($player->level > 19) and ($player->deaths == 0)){
	...
	$insert['motivo'] = "Passou do nível 19 sem nunca ter morrido.";
	$query = $db->autoexecute('medalhas', $insert, 'INSERT');
echo "Parabéns, você passou do nível 19 sem nunca ter morrido.<br/>";
...
$medalha4 = $db->execute("select * from `medalhas` where `player_id`=? and `medalha`=?", array($player->id, Milionário));
...
if ($player->worklvl > 99){
	...
	$insert['motivo'] = "Atingiu nível de trabalho 100.";
	$query = $db->autoexecute('medalhas', $insert, 'INSERT');
echo "Parabéns, você atingiu nível de trabalho 100.<br/>";
echo "Uma medalha foi adicionada ao seu perfil por este motivo.<br/><a href=\"home.php\">Voltar</a>.";
include("templates/private_footer.php");
exit;
}
...
$medalha8 = $db->execute("select * from `medalhas` where `player_id`=? and `medalha`=?", array($player->id, 'Multi-Milionário'));
if ($medalha8->recordcount() < 1) {
if (($player->gold + $player->bank) > 100000000){
	$insert['player_id'] = $player->id;   	  
	$insert['medalha'] = "Multi-Milionário";
...
if ($age2 > 99){
	...
	$insert['motivo'] = "Jogador à mais de 100 dias.";
	$query = $db->autoexecute('medalhas', $insert, 'INSERT');
echo "Parabéns, você já é jogador à mais de 100 dias.<br/>";
echo "Uma medalha foi adicionada ao seu perfil por este motivo.<br/><a href=\"home.php\">Voltar</a>.";
include("templates/private_footer.php");
exit;
}
...
if (($onuptime > 100000) and ($onuptime + 36000) < time()){
	...
	$query = $db->autoexecute('medalhas', $insert, 'INSERT');
echo "Parabéns, você está online à mais de 10 horas.<br/>";
echo "Uma medalha foi adicionada ao seu perfil por este motivo.<br/><a href=\"home.php\">Voltar</a>.";
include("templates/private_footer.php");
exit;
}
...
<tr>
<td width="50%">
<b>Usuário:</b> <?=$player->username?><br />
...
?>
<br />
<b>Pontos místicos:</b> <?=$player->magic_points?><br />
...
if ($player->magic_points == 0)
{
	echo "<a href=\"spells.php\"><b>Clique aqui para visualizar sua arvore de feitiços.</b></a>";
}
?>
...
<p>Você está entre o nivel 25 e 35, e tem uma missão à fazer. <a href="quest3.php">Clique aqui</a>.</p>
</div>
<?php } ?>
...
{ ?>
<div style="width:90%; background-color:#EEA2A2; padding:5px; border: 1px solid #DEDEDE; margin-bottom:10px" align="center">
<p>Você já passou no nivel 39, e tem uma missão à fazer. <a href="quest2.php">Clique aqui</a>.</p>
</div>
<?php } ?>
...
{ ?>
<div style="width:90%; background-color:#EEA2A2; padding:5px; border: 1px solid #DEDEDE; margin-bottom:10px" align="center">
<p>Você já passou no nivel 79, agora você pode treinar sua vocação e virar um <b><?php
...
{ ?>
<div style="width:90%; background-color:#EEA2A2; padding:5px; border: 1px solid #DEDEDE; margin-bottom:10px" align="center">
<p>Você já passou no nivel 99, e tem uma missão à fazer.</b> <a href="quest1.php">Clique aqui</a>.</p>
</div>
<?php } ?>
...
{ ?>
<div style="width:90%; background-color:#EEA2A2; padding:5px; border: 1px solid #DEDEDE; margin-bottom:10px" align="center">
<p>Você já passou no nivel 129, e tem uma missão à fazer.</b> <a href="quest4.php">Clique aqui</a>.</p>
</div>
<?php
}
?>
...
{ ?>
<div style="width:90%; background-color:#EEA2A2; padding:5px; border: 1px solid #DEDEDE; margin-bottom:10px" align="center">
<p>Você está entre o nivel 145 e 155, e tem uma missão à fazer. <a href="quest5.php">Clique aqui</a>.</p>
</div>
<?php } ?>
...
{ ?>
<div style="width:90%; background-color:#EEA2A2; padding:5px; border: 1px solid #DEDEDE; margin-bottom:10px" align="center">
<p>Você já passou do nivel 159, e pode comprar itens especiais no ferreiro. <a href="shop.php">Clique aqui</a>.</p>
</div>
<?php } ?>
...
{ ?>
<div style="width:90%; background-color:#EEA2A2; padding:5px; border: 1px solid #DEDEDE; margin-bottom:10px" align="center">
<p>Você já passou no nivel 239, agora você pode treinar sua vocação e virar um <b><?php
if ($player->voc == 'archer')
{
echo "Arqueiro Royal";
}
...
{ ?>
<div style="width:90%; background-color:#EEA2A2; padding:5px; border: 1px solid #DEDEDE; margin-bottom:10px" align="center">
<p>Você já passou do nivel 300, e tem uma missão à fazer. <a href="quest6.php">Clique aqui</a>.</p>
</div>
<?php } ?>
...
{ ?>
<div style="width:90%; background-color:#EEA2A2; padding:5px; border: 1px solid #DEDEDE; margin-bottom:10px" align="center">
<p>Você já passou do nivel 300, e tem uma missão à fazer. <a href="quest7.php">Clique aqui</a>.</p>
</div>
<?php } ?>
...
{ ?>
<div style="width:90%; background-color:#EEA2A2; padding:5px; border: 1px solid #DEDEDE; margin-bottom:10px" align="center">
<p>Você já passou do nivel 300, e tem uma missão à fazer. <a href="quest8.php">Clique aqui</a>.</p>
</div>
<?php } ?>
...
{ ?>
<div style="width:90%; background-color:#EEA2A2; padding:5px; border: 1px solid #DEDEDE; margin-bottom:10px" align="center">
<p>Você já passou do nivel 300, e tem uma missão à fazer. <a href="quest9.php">Clique aqui</a>.</p>
</div>
<?php } ?>
...
<td width="50%">
<table>
<tr><td><b>Nivel:</b></td><td><?=$player->level?></td></tr>
<tr><td><b>EXP:</b></td><td> <img src="bargen.php?exp"></td></tr>
<tr><td><b>Vida:</b></td><td> <img src="bargen.php?hp"></td></tr>
<tr><td><b>Mana:</b></td><td> <img src="bargen.php?mana"></td></tr>
<tr><td><b>Energia:</b></td><td> <img src="bargen.php?energy"></td></tr>
</table>
<br>
<b>Ouro:</b> <b><font color="#DFA40F"><?=$player->gold?></font></b><br>
<b>Vocação:</b> <?php
...
?><br />
<b>Resistência:</b> <?=$player->resistance?><?php
...
<br /><br />
<font size="1"><b>Usuários online no servidor: </b> 
<?php
$calc = (time() - 200);
...
<b>Amigos convidados:</b> <?=$player->ref?> (você ganha 2500 de ouro a cada amigo convidado).<br /><font size="1">Seu amigo deve atingir o nível <?=$setting->activate_level?> para você receber sua recompensa.</font>
