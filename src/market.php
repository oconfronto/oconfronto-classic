...
switch($_GET['act']) {
    ...
    case "amulet":
        ...
        if ($query->recordcount() == 0) {
            ...
            echo "<tr>";
            echo "<th width=\"40%\"><b><a href=\"market.php?act=" . $_GET['act'] . "&fromprice=" . $_GET['fromprice'] . "&toprice=" . $_GET['toprice'] . "&order=item&abc=";
            if($abc == "desc") {
                echo "asc";
            } elseif($abc == "asc") {
                echo "desc";
            ...
            echo "<th width=\"15%\"><b><a href=\"market.php?act=" . $_GET['act'] . "&fromprice=" . $_GET['fromprice'] . "&toprice=" . $_GET['toprice'] . "&fromeffect=" . $_GET['fromeffect'] . "&toeffect=" . $_GET['toeffect'] . "&order=efec&abc=";
            if($abc == "desc") {
                echo "asc";
            } elseif($abc == "asc") {
                echo "desc";
                ...
                echo "asc";
            } echo "\">Vitalidade</a></b></td>";
            echo "<th width=\"15%\"><b><a href=\"market.php?act=" . $_GET['act'] . "&fromprice=" . $_GET['fromprice'] . "&toprice=" . $_GET['toprice'] . "&fromeffect=" . $_GET['fromeffect'] . "&toeffect=" . $_GET['toeffect'] . "&order=cost&abc=";
            if($abc == "desc") {
                echo "asc";
            } elseif($abc == "asc") {
                echo "desc";
            ...
            echo "<th width=\"20%\"><b><a href=\"market.php?act=" . $_GET['act'] . "&fromprice=" . $_GET['fromprice'] . "&toprice=" . $_GET['toprice'] . "&fromeffect=" . $_GET['fromeffect'] . "&toeffect=" . $_GET['toeffect'] . "&order=voc&abc=";
            if($abc == "desc") {
                echo "asc";
            } elseif($abc == "asc") {
                echo "desc";
    ...
    case "potion":
        ...
        if ($query->recordcount() == 0) {
            ...
            echo "<table width=\"100%\" border=\"0\">";
            echo "<tr>";
            echo "<th width=\"50%\"><b><a href=\"market.php?act=" . $_GET['act'] . "&fromprice=" . $_GET['fromprice'] . "&toprice=" . $_GET['toprice'] . "&order=item&abc=";
            if($abc == "desc") {
                echo "asc";
            } elseif($abc == "asc") {
                echo "desc";
            ...
            echo "<th width=\"25%\"><b><a href=\"market.php?act=" . $_GET['act'] . "&fromprice=" . $_GET['fromprice'] . "&toprice=" . $_GET['toprice'] . "&fromeffect=" . $_GET['fromeffect'] . "&toeffect=" . $_GET['toeffect'] . "&order=seller&abc=";
            if($abc == "desc") {
                echo "asc";
            } elseif($abc == "asc") {
                echo "desc";
