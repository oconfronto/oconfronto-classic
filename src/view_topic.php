...
if ($_GET['up']) {
    ...
    if ($jaupou->recordcount() > 0) {
        echo "Voc� j� votou neste t�pico! <a href=\"view_topic.php?id=" . $_GET['id'] . "\">Voltar</a>.";
        include(__DIR__ . "/templates/private_footer.php");
        exit;
    }
...
echo "<b><font size=\"1\"><a href=\"select_forum.php\">F�runs</a> -> <a href=\"main_forum.php?cat=" . $rows['category'] . "\">" . ucfirst((string) $categoria) . "</a> -> <a href=\"view_topic.php?id=" . $rows['id'] . "\">" . ucfirst((string) $rows['topic']) . "</a></font></b>";
