   ...
   $db->execute("update `players` set `mana`=?, `maxmana`=? where `id`=?", [$ganha, $ganha, $player->id]);
	...
	case "search":
      ...
      $values[] = (int) $_GET['tolevel'];
		...
		echo "<tr>\n<td width=\"35%\">Nivel:</td>\n<td width=\"65%\"><input type=\"text\" name=\"fromlevel\" size=\"4\" value=\"" . stripslashes((string) $_GET['fromlevel']) . "\" /> à <input type=\"text\" name=\"tolevel\" size=\"4\" value=\"" . stripslashes((string) $_GET['tolevel']) . "\" /></td>\n</tr>\n";
