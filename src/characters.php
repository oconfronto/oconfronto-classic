...
if ($playerstrans->recordcount() > 0) {
    ...
    if ($change['pending_time'] < time()) {
        ...
        echo "<div style=\"background-color:#45E61D; padding:5px; border: 1px solid #DEDEDE; margin-bottom:10px\">Foi solicitado a transfer�ncia do personagem <b>" . $change['pending_status'] . "</b> para a conta <b>" . $coconta . "</b><br/>Ele ser� enviado em " . $valortempo2 . " " . $auxiliar2 . ". Se voc� n�o quer fazer a transfer�ncia do personagem, <a href=\"transferchar.php?cancel=true\">clique aqui</a>.</div>";
    }
    $menosespaco = 5;
}
...
if ($query04876->recordcount() > 0) {
    ...
    if ($change['pending_time'] < time()) {
        ...
        echo "<div style=\"background-color:#45E61D; padding:5px; border: 1px solid #DEDEDE; margin-bottom:10px\">Foi solicitada a mudan�a de seu email para: <b>" . $change['pending_status'] . "</b><br/>Seu email ser� alterado em " . $valortempo2 . " " . $auxiliar2 . ". Se n�o quiser mais mudar de email <a href=\"changemail.php?act=cancel\">clique aqui</a>.</div>";
    }
    $menosespaco = 5;
}
