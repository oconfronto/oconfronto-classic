...
switch($_GET['act']) {
    case "attack":
        ...
        if ($player->energy == 0) {
            ...
            if ($query->recordcount() == 0) {
                echo "Voc� n�o tem po��es de energia.";
            } else {
        ...
        if ($player->monsterkill >= $setting->securyty_capcha) {
            ...
            echo "<td height=\"100\"> Insira abaixo o c�digo abaixo exatamente como voc� v�, lembre-se de que <b>letras maiusculas s�o diferentes de minusculas</b>.<br/><br/>Se Voc� visualizar uma conta matem�tica, insira seu resultado abaixo.</td>";
            echo "</tr></table>";
            ...
            for($i = 0;$i < $attacking->combo;$i++) {
                ...
                if ($misschance <= $attacking->miss) {
                    ...
                    if ($magicchance == 2 && $attacking->magiclevel > 0) {
                        ...
                        $output .= $attacking->username . " lan�ou um feiti�o em " . $defending->username . " e tirou <b>" . $damage2 . "</b> de vida! (";
            ...
            for($i = 0;$i < $defending->combo;$i++) {
                ...
                if ($misschance <= $defending->miss) {
                    ...
                    if ($magicchance == 2 && $defending->magiclevel > 0) {
                        ...
                        $output .= $defending->username . " lan�ou um feiti�o em " . $attacking->username . " e tirou <b>" . $damage2 . "</b> de vida! (";
        ...
        if ($enemy->loot > 1) {
            ...
            if ($chanceloot == $enemy->loot) {
                ...
                if ($veositemz->recordcount() == 0) {
                    echo "Contate ao administrador que o monstro " . $enemy->username . " est� com erros.";
                    exit;
                }
                $loot_item = $veositemz->fetchrow();
                $mensagem = "<u><b>Voc� encontrou " . $loot_item['item_prepo'] . " " . $loot_item['item_name'] . " com " . $enemy->prepo . " " . $enemy->username . "</b></u>";
                $lootstatus = 5;
            ...
            if ($sorteioitem == 32) {
                ...
                if ($sorteiaitem->recordcount() == 0) {
                    $mensagem = "Contate ao administrador que o monstro " . $enemy->username . " est� com erros.";
                    $lootstatus = 2;
                } else {
                    $loot_item2 = $sorteiaitem->fetchrow();
                    $mensagem = "<u><b>Voc� encontrou um/uma " . $loot_item2['name'] . " com " . $enemy->prepo . " " . $enemy->username . "</b></u>";
                    $lootstatus = 5;
                ...
                if ($sorteiapotion == 3) {
                    $mensagem = "<u><b>Voc� encontrou uma Energy Potion com " . $enemy->prepo . " " . $enemy->username . "</b></u>";
                    $lootstatus = 5;
                    $loot_id = 137;
                } else {
                    $mensagem = "<u><b>Voc� encontrou uma Health Potion com " . $enemy->prepo . " " . $enemy->username . "</b></u>";
                    $lootstatus = 5;
                    $loot_id = 136;
                }
            } else {
        ...
        if ($player->hp <= 0) {
            ...
            $output .= "<br/><div style=\"background-color:#45E61D; padding:5px; border: 1px solid #DEDEDE; margin-bottom:10px\"><b><u>Voc� matou " . $enemy->prepo . " " . $enemy->username . "!</u></b></div>";
            $output .= "<div style=\"background-color:#FFFDE0; padding:5px; border: 1px solid #DEDEDE; margin-bottom:10px\">Voc� ganhou <b>" . $enemy->mtexp . "</b> de EXP e <b>" . $goldwin . "</b> de ouro.</div>";
            if ($mensagem != "") {
            ...
            if ($enemy->mtexp + $player->exp >= $player->maxexp) { //Player gained a level!
                ...
                $output .= "<div style=\"background-color:#45E61D; padding:5px; border: 1px solid #DEDEDE; margin-bottom:10px\"><u><b>Voc� passou de nivel!</b></u></div>";
            ...
            $output .= "<div style=\"background-color:#EEA2A2; padding:5px; border: 1px solid #DEDEDE; margin-bottom:10px\"><b><u>Os dois est�o muito can�ados para terminar a batalha! Ningu�m venceu.</u></b></div>";
    ...
    default:
        ...
        if (mysqli_num_rows($sql) > 0) {//Check if any monsters were found
            include(__DIR__ . "/templates/private_header.php");
            echo "<center><i>Voc� pode enfrentar montros do nivel " . $fromlevel . " � " . $tolevel . ".</i></center>";
            echo "<br/>";
            echo "<table width=\"100%\">\n";
