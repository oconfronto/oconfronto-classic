...
if (!defined('_ADODB_LAYER')) {
    ...
    abstract class ADOConnection
    {
        ...
        public $leftBracket = '[';		/// left square bracked for t-sql styled column names
        public $rightBracket = ']';	/// right square bracked for t-sql styled column names
        ...
        ******************************************/
         ...
         * @return string
         */
        public function SQLDate($fmt, $col = '')
        {
            if (!$col) {
                $col = $this->sysDate;
            }
         ...
         */
        public function autoExecute($table, $fields_values, $mode = 'INSERT', $where = '', $forceUpdate = true, $magic_quotes = false)
        {
    ...
    class ADORecordSet implements IteratorAggregate
    {
         ...
         */
        public $_queryID = self::DUMMY_QUERY_ID;
         ...
         * @return string HTML
         */
        public function getMenuGrouped(
            $name,
            $defstr = '',
            $blank1stItem = true,
            $multiple = false,
