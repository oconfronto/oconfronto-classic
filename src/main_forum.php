...
echo "<b><font size=\"1\"><a href=\"select_forum.php\">F�runs</a> -> <a href=\"main_forum.php?cat=" . $cate . "\">" . ucfirst((string) $categoria) . "</a></font></b>";
?>

<table width="95%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
<tr>
<td width="55%" align="center" bgcolor="#E1CBA4"><strong>T�pico</strong></td>
...
<td width="15%" align="center" bgcolor="#E1CBA4"><strong><font size=1>�ltima Postagem</font></strong></td>
</tr>
...
if ($total_players == 0) {
    echo "<tr><td align=\"center\" bgcolor=\"#FFFFFF\"><b>Nenhum t�pico encontrado.</b></td><td align=\"center\" bgcolor=\"#FFFFFF\">#</td><td align=\"center\" bgcolor=\"#FFFFFF\">#</td><td align=\"center\" bgcolor=\"#FFFFFF\">#</td></tr>";
} else {
    ...
    while($rows = mysqli_fetch_assoc($rs)) {
        ...
        if ($rows['reply'] > 0) {
            ...
            echo "<font size=\"1\">�ltimo post por <a href=\"profile.php?id=" . $lastpostname . "\">" . $lastpostname . "</a></font></td>";
        } else {
...
?>
<tr>
<td colspan="5" align="right" bgcolor="#E1CBA4"><a href="create_topic.php"><strong>Criar novo T�pico</strong> </a></td>
</tr>
</table>
<?php
echo $paginaciones;
